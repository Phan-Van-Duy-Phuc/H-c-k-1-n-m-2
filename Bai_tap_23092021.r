...
ggplot(t, aes(x=listss)) + 
  geom_histogram(binwidth = 1, boundary = 0.5, color = "gray") +
  labs(x = "Do dai bai hat tinh bang phut",
       title = "Tan suat xuat hien cua nhung bai hat co do dai tu 1 den 10 phut")
...
ggplot(t1, aes(x=listss1)) + 
  geom_histogram(binwidth = 2, boundary = 0.5, color = "blue") +
  labs(x = "Do dai bai hat tinh bang phut", 
       title = "Tan suat xuat hien cua nhung bai hat co do dai tu 1 den 10 phut")
#Tinh xac suat xuat hien cua cac bai hat co do dai hon 6
...
ggplot(t2, aes(x=listss2)) + 
  geom_histogram(binwidth = 1, boundary = 0.5, color = "yellow") +
  labs(x = "Do dai bai hat tinh bang phut",
       title = "Tan suat xuat hien cua nhung bai hat co do dai tu 1 den 10 phut")
#Tinh xac suat xuat hien cua cac bai hat co do dai hon 6
